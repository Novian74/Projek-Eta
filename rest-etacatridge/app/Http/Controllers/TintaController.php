...
{
  // Function untuk menampilkan semua data tinta
  public function index()
  {
    return Tinta::all();
  }

  // Function untuk menampilkan data toner
  public function toner()
  {
    return Tinta::orderBy('idcatridge', 'asc')->where('TC', '1')->get();
  }

  // Function untuk menampilkan data catridge
  public function catridge()
  {
    return Tinta::orderBy('idcatridge', 'asc')->where('TC', '2')->get();
  }
